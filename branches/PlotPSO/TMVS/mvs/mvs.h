...
namespace PAIS {
	...
	public:
		...
		******************/
		...
		// for showing 2D projected position with camera index & distance to GT model, modified by Chaody, 2012.Dec.01
		void writeCamProjection(const char* fileName, char *fileNameGT) const; 
